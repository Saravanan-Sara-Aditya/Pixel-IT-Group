                        ...
                        <div class="col-md-11 col-lg-8 col-xl-12 pb-7 pb-xl-5 text-center text-xl-start">
                            ...
                            <p data-aos="fade" class="lead container text-capitalize text-white opacity-75">
                                ...
                                <span className='d-block mt-2 mb-0'>
                                    ...
                                    <ul type="none">
                                        <li><FontAwesomeIcon icon={faCheckCircle} style={{ color: '#fff' }} /> Sophos</li>
                                        <li><FontAwesomeIcon icon={faCheckCircle} style={{ color: '#fff' }} /> SonicWall</li>
                                        <li><FontAwesomeIcon icon={faCheckCircle} style={{ color: '#fff' }} /> FortiGate</li>
                                    </ul>
                                </span>
