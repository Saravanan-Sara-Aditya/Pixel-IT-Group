    ...
    return (
        <div className="software-servicesh">
            ...
            <section  class="py-0 overflow-hidden" id="banner" data-bs-theme="light">
                ...
                <div class="">
                    <div data-aos="fade-down" style={{height:"100vh"}} class="row flex-center pt-8 pt-lg-8 pb-lg-9 pb-xl-0 glassmorphism-bg-1">
...
<ul type="none">
  <li><FontAwesomeIcon icon={faCheckCircle} style={{ color: '#fff' }} />	Microsoft Azure</li>
  <li><FontAwesomeIcon icon={faCheckCircle} style={{ color: '#fff' }} /> Amazon Web Services (AWS)</li>
  <li><FontAwesomeIcon icon={faCheckCircle} style={{ color: '#fff' }} /> Google Cloud</li>
  <li><FontAwesomeIcon icon={faCheckCircle} style={{ color: '#fff' }} /> Oracle Cloud Infrastructure</li>
</ul>
                            </span>
