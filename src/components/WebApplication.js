                        ...
                        <div class="col-md-11 col-lg-8 col-xl-12 pb-7 pb-xl-5 text-center text-xl-start">
                            ...
                            We understand the paramount importance of a robust online presence in today's digital landscape. Our tailored website development and support services are meticulously crafted to help businesses establish a compelling brand identity, enhance user engagement, and drive revenue growth. Here's how we excel in delivering top-notch solutions.
                                <span className='d-block mt-2 mb-0'>
                                    ...
                                    <ul type="none">
                                        <li><FontAwesomeIcon icon={faCheckCircle} style={{ color: '#fff' }} />	React.js</li>
                                        <li><FontAwesomeIcon icon={faCheckCircle} style={{ color: '#fff' }} />	Angular</li>
                                        <li><FontAwesomeIcon icon={faCheckCircle} style={{ color: '#fff' }} />	Next.js</li>
                                        <li><FontAwesomeIcon icon={faCheckCircle} style={{ color: '#fff' }} />	MERN Stack</li>
                                        <li><FontAwesomeIcon icon={faCheckCircle} style={{ color: '#fff' }} />	MEAN Stack</li>
                                        <li><FontAwesomeIcon icon={faCheckCircle} style={{ color: '#fff' }} />	React Native</li>
                                        <li><FontAwesomeIcon icon={faCheckCircle} style={{ color: '#fff' }} />	Node.js</li>
                                    </ul>
                                </span>
